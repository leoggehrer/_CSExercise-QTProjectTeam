...
//MdStart
#if ACCOUNT_ON
namespace QTProjectTeam.WebApi.Controllers.Account
{
    ...
    public sealed partial class IdentitiesController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Implemented from template developer
        ///
        public IdentitiesController(QTProjectTeam.Logic.Contracts.Account.IIdentitiesAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
