//@CodeCopy
//MdStart
namespace QTProjectTeam.CodeGenApp
{
    ...
    internal partial class Program
    {
        ...
        private static void RunApp()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine($"Code generation for: {nameof(QTProjectTeam)}");
                Console.WriteLine("=============================================");
                Console.WriteLine();
        ...
        private static string GetCurrentSolutionPath()
        {
            int endPos = AppContext.BaseDirectory
                                   .IndexOf("QTProjectTeam.CodeGenApp", StringComparison.CurrentCultureIgnoreCase);
